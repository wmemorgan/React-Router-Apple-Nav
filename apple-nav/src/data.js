export const menu = [
    ...
    subMenu: [
      {
        ...
        icon: 'https://www.apple.com/v/watch/home/n/images/watch_nav_series_2_large.svg',
        path: '/apple-watch-series-4',
        isNew: false,
      },
      {
        name: 'Apple Watch Nike+',
        icon: 'https://www.apple.com/v/watch/home/n/images/watch_nav_nike_large.svg',
        path: '/apple-watch-nike',
        isNew: false,
      },
      {
        name: 'Apple Watch Hermes',
        icon: 'https://www.apple.com/v/watch/home/n/images/watch_nav_hermes_large.svg',
        path: '/apple-watch-hermes',
        isNew: false,
      },
      {
        name: 'Apple Watch Series 3',
        icon: 'https://www.apple.com/v/watch/home/n/images/watch_nav_edition_large.svg',
        path: '/apple-watch-series-3',
        isNew: false,
      },
      {
        name: 'watchOS',
        icon: 'https://www.apple.com/v/watch/home/n/images/watch_nav_watch_os_large.svg',
        path: '/watchos-5',
        isNew: false,
      },
      {
        name: 'Bands',
        icon: 'https://www.apple.com/v/watch/home/n/images/watch_nav_bands_large.svg',
        path: '/watch/bands',
        isNew: false,
      },
      {
        name: 'Accessories',
        icon: 'https://www.apple.com/v/watch/home/n/images/watch_nav_accessories_large.svg',
        path: '',
        isNew: false,
      },
      {
        name: 'Compare',
        icon: 'https://www.apple.com/v/watch/home/n/images/watch_nav_compare_large.svg',
        path: '/watch/compare',
        isNew: false,
      }
    ],
  ...
  },
  {
    ...
    subMenu: [
      {
        name: 'Apple TV app',
        icon: 'https://www.apple.com/v/tv/home/g/images/home/apple_tv_app_dark__blle10nnpq3m_large.svg',
        path: '/apple-tv-app',
        isNew: true,
      },
      {
        name: 'Apple TV+',
        icon: 'https://www.apple.com/v/tv/home/g/images/home/apple_tv_plus_dark__fntbqaxjuouy_large.svg',
        path: '/apple-tv-plus',
        isNew: true,
      },
      {
        name: 'Apple TV 4K',
        icon: 'https://www.apple.com/v/tv/home/g/images/home/apple_tv_dark__ern1bz8tkwqe_large.svg',
        path: '/apple-tv-4k',
        isNew: false,
      },
      {
      ...
      {
        name: 'AirPlay',
        icon: 'https://www.apple.com/v/tv/home/g/images/home/airplay_dark__dqiw3rzeujma_large.svg',
        path: '/airplay',
        isNew: false,
      },
      {
        name: 'Accessories',
        icon: 'https://www.apple.com/v/tv/home/g/images/home/accessories_dark__dybfk40y28om_large.svg',
        path: '/tv/accessories',
        isNew: false,
      },
    ],
